            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="mb-16">
                <div className="text-center mb-10">
                  <h3 className="font-heading text-2xl font-bold mb-3">Примеры наших работ</h3>
                  <p className="text-muted-foreground">
                    Реальные результаты русификации различных автомобилей
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="overflow-hidden group hover:shadow-xl transition-all duration-300">
                    <div className="relative h-64 overflow-hidden">
                      <img 
                        src="https://cdn.poehali.dev/projects/c4b0cb42-73ec-4bbe-92b0-d10bcd013982/files/6085224d-43ca-4349-83af-cb2830cb8867.jpg"
                        alt="Русификация мультимедийной системы"
                        className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                      <div className="absolute bottom-4 left-4 right-4">
                        <Badge className="mb-2 bg-primary">Мультимедиа</Badge>
                        <p className="text-white font-semibold">Русификация головного устройства</p>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card className="overflow-hidden group hover:shadow-xl transition-all duration-300">
                    <div className="relative h-64 overflow-hidden">
                      <img 
                        src="https://cdn.poehali.dev/projects/c4b0cb42-73ec-4bbe-92b0-d10bcd013982/files/1f8c76c0-95d3-45e3-a02d-e3873cac5d23.jpg"
                        alt="Русификация навигационной системы"
                        className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                      <div className="absolute bottom-4 left-4 right-4">
                        <Badge className="mb-2 bg-primary">Навигация</Badge>
                        <p className="text-white font-semibold">Русские карты и меню</p>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card className="overflow-hidden group hover:shadow-xl transition-all duration-300">
                    <div className="relative h-64 overflow-hidden">
                      <img 
                        src="https://cdn.poehali.dev/projects/c4b0cb42-73ec-4bbe-92b0-d10bcd013982/files/a2f388fb-dafc-41f3-9cef-d7fb8726fb76.jpg"
                        alt="Русификация приборной панели"
                        className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                      <div className="absolute bottom-4 left-4 right-4">
                        <Badge className="mb-2 bg-primary">Панель приборов</Badge>
                        <p className="text-white font-semibold">Цифровая приборка на русском</p>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card className="overflow-hidden group hover:shadow-xl transition-all duration-300">
                    <div className="relative h-64 overflow-hidden">
                      <img 
                        src="https://cdn.poehali.dev/projects/c4b0cb42-73ec-4bbe-92b0-d10bcd013982/files/1ede8764-b908-4da4-8ecd-ff22695af5e9.jpg"
                        alt="Русификация Toyota"
                        className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                      <div className="absolute bottom-4 left-4 right-4">
                        <Badge className="mb-2 bg-primary">Toyota</Badge>
                        <p className="text-white font-semibold">Полная русификация системы</p>
                      </div>
                    </div>
                  </Card>
                </div>
